...
## Description
BetterHealth is a mental health companion application for college students. Users can log things such as study sessions and also log their personal performance such as their mood. Other students' data will be compared to what is provided by the user. The user will be benchmarked. 
...
```bash
git clone https://github.com/jmoner17/cs3620-project
